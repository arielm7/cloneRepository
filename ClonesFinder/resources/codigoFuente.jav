...
class InitializeConstructorParametersStatementsGenerator {
    ...
    public static void main(String[] args) {
        ...
        Constructor<?> constructor111111 = 
        		findAllFieldsConstructor(nodeClass);
    }
    
    
    void generate(Class<? extends Node> nodeClass, NodeList<Statement> initializeConstructorParametersStatements) {
        if (nodeClass == Node.class) { //comentarios
            return;
        }
        Constructor<?> constructor111111 = findAllFieldsConstructor(nodeClass);
